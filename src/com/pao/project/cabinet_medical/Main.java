        ...
        do {
            ...
            switch (optiune) {
                case 1:
                    ...
                    List<Client> clientiGasiti = serviciuClienti.cautaDupaNume(numeClient);
                    ...
                    for (Medic m : serviciuMedici.listeazaToti()) {
                    ...
                    try {
                        ...
                        Programare programareNoua = serviciuProgramari.creareProgramare(clientSelectat, medicSelectat, dataOra, pretBaza);
                ...
                case 3:
                    ...
                    List<Client> clientiIstoric = serviciuClienti.cautaDupaNume(numeClientIstoric);
                    if (clientiIstoric.isEmpty()) {
                        System.out.println("Client inexistent.");
                    } else {
                        Client cIst = clientiIstoric.get(0);
                        for (Programare p : serviciuProgramari.afisareIstoricProgramari(cIst)) {
                ...
                case 4:
                    ...
                    Programare pAnulare = serviciuProgramari.cautaDupaCod(codAnulare);
                    if (pAnulare == null) {
                        System.out.println("Nu exista programare cu acest cod.");
                    } else {
                        serviciuProgramari.anulareProgramare(pAnulare);
                ...
                case 5:
                    ...
                    Programare pReprog = serviciuProgramari.cautaDupaCod(codReprog);
                    if (pReprog == null) {
                        System.out.println("Nu exista programare cu acest cod.");
                    } else {
                        ...
                        try {
                            ...
                            serviciuProgramari.reprogramare(pReprog, nouaDataOra);
                ...
                case 6:
                    ...
                    List<Client> clientiAnalize = serviciuClienti.cautaDupaNume(numeClientAnalize);
                    if (!clientiAnalize.isEmpty()) {
                        serviciuProgramari.afisareRezultateAnalize(clientiAnalize.get(0));
                    } else {
                        System.out.println("Client inexistent.");
                    }
                    break;
                case 7:
                    ...
                    List<Client> clientiExport = serviciuClienti.cautaDupaNume(numeClientExport);
                    if (!clientiExport.isEmpty()) {
                        serviciuProgramari.exportareIstoricMedical(clientiExport.get(0));
                    } else {
                        System.out.println("Client inexistent.");
                    }
                    break;
                case 8:
                    ...
                    List<Client> clientiCont = serviciuClienti.cautaDupaNume(numeClientCont);
                    if (!clientiCont.isEmpty()) {
                        serviciuProgramari.afisareContClient(clientiCont.get(0));
                    } else {
                        System.out.println("Client inexistent.");
                    }
                    break;
                case 9:
                    ...
                    if (medicOrar != null) {
                        serviciuMedici.afiseazaOrarMedic(medicOrar);
                    } else {
                ...
                case 10:
                    ...
                    List<Client> clientiOferte = serviciuClienti.cautaDupaNume(numeClientOferte);
                    if (!clientiOferte.isEmpty()) {
                        serviciuProgramari.calculareOferte(clientiOferte.get(0));
                    } else {
                        System.out.println("Client inexistent.");
                    }
                    break;
                case 11:
                    ...
                    serviciuClienti.adauga(clientNou);
                ...
                case 12:
                    ...
                    serviciuMedici.adauga(medicNou);
